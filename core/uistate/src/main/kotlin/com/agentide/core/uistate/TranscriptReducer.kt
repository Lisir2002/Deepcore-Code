...
import com.agentide.core.model.ContextCompacted
...
class TranscriptReducer {
    ...
    private fun labelOf(attachment: com.agentide.core.model.Attachment): String = when (attachment) {
        is com.agentide.core.model.Attachment.File -> attachment.path.substringAfterLast('/')
        is com.agentide.core.model.Attachment.Image -> "图片"
        is com.agentide.core.model.Attachment.Text -> attachment.title
    }
